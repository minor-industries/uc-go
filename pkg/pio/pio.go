...
func (cfg *PIOStateMachineConfig) SetSetPins(base machine.Pin, count uint8) {
...
func (sm *PIOStateMachine) SetConsecutivePinDirs(pin machine.Pin, count uint8, isOut bool) {
